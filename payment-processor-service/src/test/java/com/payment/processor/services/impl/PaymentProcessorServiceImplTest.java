...
/**
 * Test class for PaymentProcessorService methods.
 *
...
class PaymentProcessorServiceImplTest {
    ...
    private final PaymentProcessorServiceImpl service = new PaymentProcessorServiceImpl(null, null);
